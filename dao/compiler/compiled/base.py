...
# multiple shot generators list
# use the fun and args regenerate the generator
def apply_multishot_generator_list(fun_args_list):
  i = 0
...
# multiple shot generators and functions list
# use the fun and args regenerate the generator or function result
def apply_generator_function_list(fun_args_list):
  i = 0
  length = len(fun_args_list)
  #gen_list[0] = [fun_args_list[0][0](*fun_args_list[0][1:])]+[None]*(length-1)
  #result = [None]*length
