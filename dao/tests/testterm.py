...
from dao.builtin import *
from dao.error import UnifyFail, CatchableError
from dao.term import string, Var, term, Term, userTerm, nonterminal, function
from dao.rule import rule, Rule 
from dao.engine import Trail, Engine
...
from dao.term import DynamicVar
...
class TestCons:
  def testUnify(self):
    from dao.termlib import conslist as termList
    trail = Trail()
    l1= termList(12, 23)
    l2 = termList(12, 23)
    l1.unify(l2, trail)
...
from dao.termlib import QuasiquoteListTerm as ql, at
class TestListTerm:
  def testUnify(self): 
    trail = Trail()
    l1= ql(12, 23)
